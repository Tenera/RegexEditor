...
using Regulator.SDK.Settings;
using Syncfusion.Windows.Forms.EditCustom;
...
namespace Regulator.Ctl
{
	...
	public class RegexEditor : System.Windows.Forms.UserControl
	{
		...
		public  Syncfusion.Windows.Forms.EditCustom.EditControl txtRegex;
		...
		private void InitializeEditControl()
		{
			this.SuspendLayout();
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(RegexEditor));
			this.txtRegex = new Syncfusion.Windows.Forms.EditCustom.EditControl();
			...
			this.txtRegex.ContextChoicePopup += new Syncfusion.Windows.Forms.EditCustom.ContextChoicePopupEventHandler(this.txtRegex_ContextChoicePopup);
		...
		private void txtRegex_ContextChoicePopup(object sender, Syncfusion.Windows.Forms.EditCustom.ContextChoicePopupEventArgs e)
		{
		...
		private void InitContextChoices( Syncfusion.Windows.Forms.EditCustom.ContextChoicePopupEventArgs e)
		{
		...
		private void FillNamedGroups( Syncfusion.Windows.Forms.EditCustom.ContextChoicePopupEventArgs e)
		{
			InitContextChoices(e);
		...
		private void FillContextPopupChoices(Syncfusion.Windows.Forms.EditCustom.ContextChoicePopupEventArgs e)
		{
			if(NamedGroupsMode)
			{
				return ;
			...
			{
				e.Choices.Add("Error adding choices...");
				e.ImageIndexes.Add(IMG_ERROR);
