...
namespace Regulator.GUI
{
	...
	/// </summary>
	public class RegexDocument : System.Windows.Forms.Form,IRegexDisplay
	{
		...
		private System.Windows.Forms.TabControl tabSctInputPart;
		private System.Windows.Forms.Splitter splitter2;
		private System.Windows.Forms.TabPage tabMatches;
		private System.Windows.Forms.TreeView Tree;
		private System.Windows.Forms.TabPage tabOutput;
		private System.Windows.Forms.RichTextBox txtOutputReplace;
		private C1.Win.C1Command.C1Command cmdCancelAction;
		private C1.Win.C1Command.C1Command cmdECMAScript;
		...
		private System.Windows.Forms.ContextMenu QuickRegexContexMenu;
		private System.Windows.Forms.MenuItem mnuNewAdd;
		...
		private System.Windows.Forms.OpenFileDialog dlgInputFileSelection;
		private C1.Win.C1Command.C1ToolBar c1ToolBar1;
		private C1.Win.C1Command.C1CommandLink c1CommandLink1;
		private C1.Win.C1Command.C1CommandControl mnuInputFile;
		private System.Windows.Forms.TextBox txtInputFilename;
		private C1.Win.C1Command.C1CommandLink c1CommandLink2;
		private C1.Win.C1Command.C1Command cmdmnuSelectInputFile;
		private C1.Win.C1Command.C1CommandLink c1CommandLink3;
		private C1.Win.C1Command.C1Command cmdmnuRefreshFromInputFile;
		private System.Windows.Forms.ListView lvSplits;
		private System.Windows.Forms.ColumnHeader Index;
		private System.Windows.Forms.ColumnHeader text;
		private System.Windows.Forms.TabPage tabInputText;
		private System.Windows.Forms.TabPage tabReplaceWith;
		private const int ICON_CAPTURE= 2;
		private Regulator.Ctl.RegexEditor txtRegex;
		private Regulator.Ctl.RegexEditor txtReplaceWith;
		...
		public void DisplayPlugin(Regulator.SDK.Plugins.IPlugin plugin)
		{
		...
		private void RegexDocument_Load(object sender, System.EventArgs e)
		{
			EnableRunButtonsOnDocument(true);
			Dirty=false;
...
//			statusBar.Panels[2].Text="";
		...
		private void StartThreadIfPossible(ThreadStart starter)
		{
			...
			if(_executingRegexThread!=null && 
				_executingRegexThread.ThreadState==System.Threading.ThreadState.Running)
			{
	  ...
	  public void LoadFile(string fileName)
		...
		private void panel2_Paint_1(object sender, System.Windows.Forms.PaintEventArgs e)
		{
		...
		private void txtRegex_Changed(object sender, System.EventArgs e)
		{
			Dirty=true;
		}
		...
		private void txtRegex_KeyPress(object sender, System.Windows.Forms.KeyPressEventArgs e)
		{
			
		}

		private void txtRegex_Load(object sender, System.EventArgs e)
		{
		...
		private void RegexDocument_Activated(object sender, System.EventArgs e)
		{
			AppContext.Instance.OnProjectChange(_currentProject);
		}

		private void txtRegex_ModifiedChanged(object sender, System.EventArgs e)
		{
			
		}

		private void txtInput_TextChanged_1(object sender, System.EventArgs e)
		{
			Dirty=true;
			SetCurrentProjectProperties();
		}
		...
		private void txtRegex_BackColorChanged(object sender, System.EventArgs e)
		{
			//OnOptionsChanged();
		...
		private void txtRegex_BackgroundImageChanged(object sender, System.EventArgs e)
		{
//			OnOptionsChanged();
		}

		private void txtRegex_ForeColorChanged(object sender, System.EventArgs e)
		{
			//OnOptionsChanged();
		}
		...
		private void RegexDocument_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			if(!CloseVerified && 
				!VerifyCanClose())
			{
		...
		private void cmdInputChildRefreshFromFile_Click(object sender, System.EventArgs e)
		{
		...
		private void DownloadURL()
		{
			try
			{
				...
				Application.DoEvents();
				System.Net.WebRequest request = System.Net.WebRequest.Create(txtInputFilename.Text);
		...
		private void cmdInputChildSelectFile_Click(object sender, System.EventArgs e)
		{
			SelectInputFile();
		}
		...
		private void cmdmnuRefreshFromInputFile_Click(object sender, C1.Win.C1Command.ClickEventArgs e)
		{
			RefreshTextFromInputFile();
		}

		private void cmdmnuSelectInputFile_Click(object sender, C1.Win.C1Command.ClickEventArgs e)
		{
			SelectInputFile();
		}

		private void txtInputFilename_TextChanged(object sender, System.EventArgs e)
		{
			SetCurrentProjectProperties();
		}
		...
		private void txtInputFilename_KeyPress(object sender, System.Windows.Forms.KeyPressEventArgs e)
		{
		}

		private void txtInputFilename_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		private void txtInputFilename_Enter(object sender, System.EventArgs e)
		{
			
		}

		private void txtInputFilename_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			
		
		}

		private void c1ToolBar1_Enter(object sender, System.EventArgs e)
		{
		
		}

		private void c1ToolBar1_Click(object sender, System.EventArgs e)
		{
			
		
		}

		private void txtRegex_ContextTooltipPopup(object sender, Syncfusion.Windows.Forms.EditCustom.ContextTooltipPopupEventArgs e)
		{
			//e.ItemTooltip= e.ItemName;
		}

		private void txtRegex_ContextPromptPopup(object sender, Syncfusion.Windows.Forms.EditCustom.ContextPromptPopupEventArgs e)
		{
		}



		private void txtRegex_ContentChanged_1(object sender, Syncfusion.Windows.Forms.EditCustom.ContentChangedEventArgs e)
		{
		...
		private void tabSctInputPart_Enter(object sender, System.EventArgs e)
		{
			
		}

		private void txtReplaceWith_Updated(object sender, System.EventArgs e)
		{
			SetCurrentProjectProperties();
		}
